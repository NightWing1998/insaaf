				...
				<center>
					<div className="file-input" onDragOver={dragOver} onDragEnter={dragOver} onDragLeave={dragEnd} onDragEnd={dragEnd} onDrop={onDrop}>
						...
						{file === null ?
							...
							:
							<>
								<svg className="file-input__icon" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enableBackground="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512">
									<g>
					...
					<Grid columns={2}>
						<Grid.Row>
							<Grid.Column>
								<Button type="submit" style={{ backgroundColor: "green", color: "white", float: "right" }} disabled={file ? false : true} loading={submited} >Submit</Button>
							</Grid.Column>
							<Grid.Column>
								<Button type="reset" style={{ backgroundColor: "red", color: "white", float: "left" }} onClick={() => { setFile(null); props.handleFileChange(null) }} disabled={file ? false : true} >Clear</Button>
							</Grid.Column>
						</Grid.Row>
					</Grid>
				</center>
